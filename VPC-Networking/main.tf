...
resource "aws_subnet" "prod-public_subnet-1" {
  vpc_id                  = aws_vpc.prod-vpc.id
  cidr_block              = var.public_subnets_cidr_1
  availability_zone       = data.aws_availability_zones.zone_available.names[0]
...
resource "aws_subnet" "prod-public_subnet-2" {
  vpc_id                  = aws_vpc.prod-vpc.id
  cidr_block              = var.public_subnets_cidr_2
  availability_zone       = data.aws_availability_zones.zone_available.names[1]
  map_public_ip_on_launch = var.map_public_ip_on_launch
...
resource "aws_route_table_association" "public_route_table_association_1" {
  subnet_id      = aws_subnet.prod-public_subnet-1.id
  route_table_id = aws_route_table.public_route_table.id
}
resource "aws_route_table_association" "public_route_table_association_2" {
  subnet_id      = aws_subnet.prod-public_subnet-2.id
  route_table_id = aws_route_table.public_route_table.id
}
